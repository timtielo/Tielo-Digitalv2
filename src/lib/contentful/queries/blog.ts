...
import type { ContentfulBlogPost, ContentfulResponse } from '../types';
...
export async function getBlogPost(slug: string): Promise<ContentfulBlogPost | null> {
  try {
...
export async function getBlogPosts(page = 1, limit = 12): Promise<BlogPostsResponse> {
  try {
