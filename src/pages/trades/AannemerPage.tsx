...
const features = [
  'Projectportfolio met grote beelden',
  'Voor- en na-foto\'s',
  'Over ons pagina die vertrouwen opbouwt',
  'Referenties van eerdere opdrachtgevers',
  'Offerte-aanvraag formulier',
  'Vindbaarheid op "aannemer + regio"',
];
...
export function AannemerPage() {
  return (
    <div className="min-h-screen bg-white">
      <SEO
        title="Website laten maken als aannemer | Tielo Digital"
        description="Website voor aannemers. Projectportfolio, referenties en offerte-formulier. Positioneer jezelf als serieuze partij voor grotere projecten."
        keywords={['website aannemer', 'aannemer website laten maken', 'aannemersbedrijf website', 'bouwbedrijf online']}
        canonical="https://www.tielo-digital.nl/diensten/websites/aannemer"
      />
        ...
        <div className="container mx-auto px-4 sm:px-6 relative">
          ...
          >
            ...
            <h1 className="text-4xl md:text-5xl font-bold text-tielo-navy mb-6 tracking-tight leading-[1.15]">
              Website laten maken als aannemer
            </h1>
            <div className="text-lg text-tielo-navy/70 leading-relaxed space-y-4">
              <p>Als aannemer verkoop je geen kleine klusjes.</p>
              <p>Je verkoopt vertrouwen, vakmanschap en projecten van duizenden euro's.</p>
              <p className="font-medium">Dan moet je online uitstraling dat ook laten zien.</p>
              <p>Een simpele vermelding op Werkspot is niet genoeg voor grotere opdrachten, VvE's of nieuwbouwprojecten.</p>
              <p className="font-semibold text-tielo-navy">Je hebt een professionele website nodig die jouw projecten laat spreken.</p>
            </div>
      ...
      <section className="py-16 sm:py-24 bg-white">
        <div className="container mx-auto px-4 sm:px-6">
          <div className="max-w-3xl mx-auto">
            ...
            >
              De website positioneert jou als serieuze partij.
            </motion.p>
          </div>
        </div>
      </section>
          ...
          <div className="max-w-3xl mx-auto">
            ...
            >
              <p className="text-tielo-navy/70 leading-relaxed">
                Ik help ook andere bouwprofessionals met hun online aanwezigheid. Bekijk de pagina's voor{' '}
        ...
        <div className="container mx-auto px-4 sm:px-6 relative">
          ...
          >
            <h2 className="text-3xl sm:text-4xl font-bold mb-4 text-tielo-navy tracking-tight">
              Grotere projecten aantrekken?
            </h2>
            <p className="text-lg mb-8 text-tielo-navy/60">
              Plan een kort gesprek.<br />
              Ik laat zien hoe jouw werk professioneel online gepresenteerd kan worden.
            </p>
