...
const features = [
  'Duidelijke pagina\'s voor installaties, keuringen en laadpalen',
  'Certificeringen zichtbaar (bijv. NEN)',
  'Projectvoorbeelden',
  'Google vindbaarheid per regio',
  'Contact via WhatsApp of offerteformulier',
  'Strakke, technische uitstraling',
];
...
export function ElektricienPage() {
  return (
    <div className="min-h-screen bg-white">
      <SEO
        title="Website laten maken als elektricien | Tielo Digital"
        description="Website voor elektriciens. Installaties, keuringen, laadpalen en certificeringen duidelijk online. Focus op betrouwbaarheid en expertise."
        keywords={['website elektricien', 'elektricien website laten maken', 'elektricien online', 'installateur website']}
        canonical="https://www.tielo-digital.nl/diensten/websites/elektricien"
      />
        ...
        <div className="container mx-auto px-4 sm:px-6 relative">
          ...
          >
            ...
            <h1 className="text-4xl md:text-5xl font-bold text-tielo-navy mb-6 tracking-tight leading-[1.15]">
              Website laten maken als elektricien
            </h1>
          ...
          <div className="max-w-3xl mx-auto">
            ...
            >
              ...
              <h2 className="text-3xl font-bold text-tielo-navy mb-4">
                Wat ik voor elektriciens regel
              </h2>
            </motion.div>
            ...
            >
              De focus ligt op betrouwbaarheid en expertise.
            </motion.p>
          </div>
        </div>
      </section>
          ...
          <div className="max-w-3xl mx-auto">
            ...
            >
              <p className="text-tielo-navy/70 leading-relaxed">
                Ik help ook andere vakmannen in de bouw met professionele websites. Bekijk de pagina's voor{' '}
        ...
        <div className="container mx-auto px-4 sm:px-6 relative">
          ...
          >
            <h2 className="text-3xl sm:text-4xl font-bold mb-4 text-tielo-navy tracking-tight">
              Professioneel zichtbaar als elektricien?
            </h2>
            <p className="text-lg mb-8 text-tielo-navy/60">
              Vertel me in welke regio je werkt.<br />
              Ik maak een voorstel dat past bij jouw vakgebied.
            </p>
