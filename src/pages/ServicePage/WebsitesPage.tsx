  ...
  return (
    <div className="min-h-screen">
      <SEO
        ...
        description="Complete website voor vaklui. Professioneel ontwerp, Google vindbaar, WhatsApp integratie, reviews en hosting. Eenmalig €1.375, jaarlijks €215 (ex BTW)."
        keywords={[
          'Website vakman',
          'Website loodgieter',
          'Website aannemer',
