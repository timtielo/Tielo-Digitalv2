...
export function WebsitesCTA({
  ...
  const defaultTitles = {
    primary: "Klaar om je eigen website te hebben?",
    secondary: "Wil je meer weten?",
    minimal: "Interesse?"
  };

  const defaultDescriptions = {
    primary: "Vertel me over je bedrijf en ik laat zien wat ik voor je kan bouwen",
    secondary: "Plan een kort gesprek en ik vertel je precies wat een website voor jouw bedrijf kan betekenen",
    minimal: "Neem contact op voor een vrijblijvend gesprek"
  };

  const bgColors = {
    primary: "bg-tielo-cream",
    secondary: "bg-tielo-offwhite",
    minimal: "bg-white"
  };

  return (
    <section className={`py-16 sm:py-24 ${bgColors[variant]} relative overflow-hidden`}>
